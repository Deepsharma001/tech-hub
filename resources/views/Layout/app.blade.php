...
<html lang="en">
  <head>
    <title>StudyBABA || As You Think</title>
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.php">StudyBABA</a>
    			</div>
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
						    ...
						    <div class="text">
						    	<span>Call</span>
						    	<span>Call Us: +91 89497-64990</span>
						    </div>
					    </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |<i class="fa fa-coffee" aria-hidden="true"></i> <a href="https://studybaba.in" target="_blank"><b>StudyBABA</b></a>
  ...
  <script src="https://use.fontawesome.com/a36d61e50a.js"></script>
